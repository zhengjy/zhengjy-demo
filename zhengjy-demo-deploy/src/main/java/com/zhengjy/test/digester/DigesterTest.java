package com.zhengjy.test.digester;
import java.io.File;
...
/**
 * Created by zhengjy on 2017/5/15.
 */
    ...
    public void digester() throws IOException, SAXException{
        ...
        */
        digester.addObjectCreate("School",
                "com.zhengjy.test.digester.School",
                "className");
        ...
        digester.addObjectCreate("School/Grade",
                "com.zhengjy.test.digester.Grade",
                "className");
        ...
        digester.addObjectCreate("School/Grade/Class",
                "com.zhengjy.test.digester.Class",
                "className");
