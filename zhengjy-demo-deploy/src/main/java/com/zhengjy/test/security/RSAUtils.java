 ...
 *  因为最终呈现的是编码后的字符串，所以你可以分段加密，分段编码和分段加密，一次编码两种方式（上面的代码采用的是后一种，也推荐采用这一种）。
 *  相信我不是所有人的脑回路都一样的，尤其是当他采用的开发语言和你不通时。**
 * ---------------------
 * 作者：少年_你够了
 * 来源：CSDN
 * 原文：https://blog.csdn.net/cz0217/article/details/78426733
 * 版权声明：本文为博主原创文章，转载请附上博文链接！
 *
 *
 * Created by Jiyang.Zheng on 2019/1/24 17:06.
 */
public class RSAUtils {
    ...
    public static void main (String[] args) throws Exception {
        ...
        String str = "站在大明门前守卫的禁卫军，事先没有接到\n" +
                ...
                "心中揣测，互相询问：所谓午朝是否讹传？既无几案既无几案既无几案既无几案既无几案既无几案既无几案";
